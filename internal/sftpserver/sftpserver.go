...
// Serve accepts connections on an existing listener until Close is called or
// the listener returns an unexpected error.
func (s *Server) Serve(ln net.Listener) error {
	if ln == nil {
		return errors.New("sftp listener is nil")
	}
